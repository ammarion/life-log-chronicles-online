        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 font-inter">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Personal Growth</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Mindfulness</a></li>
